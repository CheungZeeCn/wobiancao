...
<?php echo $this->Form->create('WbcUser'); ?>
	<fieldset>
		<legend><?php echo __('Edit Wbc User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('WbcUser.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('WbcUser.id')))); ?></li>
